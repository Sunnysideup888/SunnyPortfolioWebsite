...
{#if isVisible}
	...
	>
		<img
			src="/sunny_snow_background.jpg"
			alt="Me in the snow"
			class="absolute inset-0 h-full w-full object-cover"
		/>
		<div
			class="absolute top-1/2 left-1/2 z-10 w-[90%] -translate-x-1/2 -translate-y-1/2 sm:left-auto sm:w-100 sm:translate-x-0 md:right-[6%] lg:right-[15%]"
		>
			<div
			...
			>
				...
				<h2 class="text-l mt-4 font-light text-black dark:text-white">
		...
		<div
			class="absolute inset-x-0 top-0 h-1/5 bg-gradient-to-b from-[#aacbce] to-transparent"
		></div>
	</div>
{/if}
